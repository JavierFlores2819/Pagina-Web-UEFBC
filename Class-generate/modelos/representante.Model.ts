        ...
        FECHA_CREACION: string;
              constructor(REP_ID: number, REP_DNI: string, REP_NOM: string, REP_NOM2: string, REP_APE: string, REP_APE2: string, REP_DIR: string, REP_CEL: string, REP_TEL: string, REP_MAIL: string, REP_REL_FAM: string, REP_ESTADO: string, USR_CREADOR_ID: number, FECHA_CREACION: string) {
                  this.REP_ID = REP_ID;
