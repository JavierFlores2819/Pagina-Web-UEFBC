...
export class ProfesorComponent {
  ...
  docente: profesor = {
    PRF_ID: 0, PRF_DNI: "", PRF_NOM: "", PRF_NOM2: "", PRF_APE: "", PRF_APE2: "", PRF_FECH_NAC: "", PRF_GEN: "", PRF_DIR: "", PRF_CEL: "",
  ...
  guardarDocente() {
    if (this.id != 'crear') {
      //editar
      let param = {
        "tabla": "profesor", "campos": [
          { "nombre": "PRF_ID", "valor": this.docente.PRF_ID },
          { "nombre": "PRF_DNI", "valor":this.docente.PRF_DNI },
          { "nombre": "PRF_NOM", "valor": this.docente.PRF_NOM },
          { "nombre": "PRF_NOM2", "valor": this.docente.PRF_NOM2 },
          { "nombre": "PRF_APE", "valor": this.docente.PRF_APE },
          { "nombre": "PRF_APE2", "valor": this.docente.PRF_APE2 },
          { "nombre": "PRF_FECH_NAC", "valor": this.docente.PRF_FECH_NAC },
          { "nombre": "PRF_GEN", "valor": this.docente.PRF_GEN },
          { "nombre": "PRF_DIR", "valor": this.docente.PRF_DIR },
          { "nombre": "PRF_CEL", "valor": this.docente.PRF_CEL },
          { "nombre": "PRF_TEL", "valor": this.docente.PRF_TEL },
          { "nombre": "PRF_MAIL", "valor": this.docente.PRF_MAIL },
          { "nombre": "PRF_FECH_INGR_INST", "valor": this.docente.PRF_FECH_INGR_INST },
          { "nombre": "PRF_FECH_INGR_MAG", "valor": this.docente.PRF_FECH_INGR_MAG },
          { "nombre": "PRF_ESTADO", "valor": this.docente.PRF_ESTADO },
          { "nombre": "USR_CREADOR_ID", "valor": this.docente.USR_CREADOR_ID }
        ]
      }
      this.docenteService.updateDocente(param).subscribe(data=>{
        console.log('profe editado');
