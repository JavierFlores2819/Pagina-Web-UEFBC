...
export class EstudianteComponent {
  ...
  repre: representante = {
    REP_ID: 0, REP_DNI: "", REP_NOM: "", REP_NOM2: "", REP_APE: "", REP_APE2: "", REP_DIR: "", REP_CEL: "", REP_TEL: "", REP_MAIL: "", REP_ESTADO: "D",
    USR_CREADOR_ID: 1
  }
  estudiante: estudiante = {
    EST_ID: 0, EST_DNI: "", EST_NOM: "", EST_NOM2: "", EST_APE: "", EST_APE2: "", EST_FECH_NAC: "", EST_GEN: "", EST_ESTADO: "A", REP_ID: 0, REL_EST_REP: "PAPA",
    ...
    if (this.id != 'crear') {
      let param = {
        "tabla": "estudiante", "campos": [
          { "nombre": "EST_ID", "valor": this.estudiante.EST_ID },{ "nombre": "EST_DNI", "valor": this.estudiante.EST_DNI },
          { "nombre": "EST_NOM", "valor": this.estudiante.EST_NOM },{ "nombre": "EST_NOM2", "valor": this.estudiante.EST_NOM2 },
          { "nombre": "EST_APE", "valor": this.estudiante.EST_APE },{ "nombre": "EST_APE2", "valor": this.estudiante.EST_APE2 },
          { "nombre": "EST_FECH_NAC", "valor": this.estudiante.EST_FECH_NAC},{ "nombre": "EST_GEN", "valor":this.estudiante.EST_GEN },
          { "nombre": "EST_ESTADO", "valor": this.estudiante.EST_ESTADO},{ "nombre": "REP_ID", "valor":this.estudiante.REP_ID },
          { "nombre": "REL_EST_REP", "valor": this.estudiante.REL_EST_REP},{ "nombre": "USR_CREADOR_ID", "valor": this.estudiante.USR_CREADOR_ID },
          { "nombre": "EST_PRO", "valor": this.estudiante.EST_PRO },{ "nombre": "EST_CAN", "valor": this.estudiante.EST_CAN },
          { "nombre": "EST_PARR", "valor": this.estudiante.EST_PARR},{ "nombre": "EST_CUE", "valor":this.estudiante.EST_CUE },
          { "nombre": "EST_DIR", "valor":this.estudiante.EST_DIR },{ "nombre": "EST_NAC", "valor": this.estudiante.EST_NAC },
          { "nombre": "EST_ETN", "valor": this.estudiante.EST_ETN },{ "nombre": "EST_NAC_ETN", "valor": this.estudiante.EST_NAC_ETN },
          { "nombre": "EST_COM_ETN", "valor": this.estudiante.EST_COM_ETN },{ "nombre": "NEE_DIS", "valor": this.estudiante.NEE_DIS },
          { "nombre": "NES_NAD", "valor": this.estudiante.NES_NAD },{ "nombre": "ENF_CAT", "valor": this.estudiante.ENF_CAT },
          { "nombre": "CONADIS", "valor":  this.estudiante.CONADIS }, { "nombre": "EST_INTE", "valor": this.estudiante.EST_INTE },
          { "nombre": "EST_TV", "valor": this.estudiante.EST_TV },{ "nombre": "EST_RAD", "valor": this.estudiante.EST_RAD },
          { "nombre": "EST_PC", "valor": this.estudiante.EST_PC},{ "nombre": "EST_CEL", "valor": this.estudiante.EST_CEL }
        ] }
      this.estService.updateEstudiante(param).subscribe(data => {
        console.log('est editado');
  ...
  cargarEstudiante() {
    ...
    this.estService.getEstudiante(param).subscribe(data => {
      ...
      if (this.estudiante.EST_ESTADO == 'A') {
        this.chbxEst = true
